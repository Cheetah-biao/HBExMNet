...
from utils.project_paths import repo_root, workspace_root, find_external_or_repo_dir
...
def parse(opt_path, mode="Train", model_name='model_name', inference_selection=None):
    ...
    experiments_dir = str(find_external_or_repo_dir('experiments'))
    if mode == "Train":
        opt['is_train'] = True
        experiments_root = osp.join(experiments_dir, model_name)
